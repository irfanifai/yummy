...
<div class="card shadow mb-2">
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary"> Daftar Pesan</h6h>
    </div>
    ...
    <div class="card">
        ...
        <div class="col-4 float-right mb-4">
            <form action="{{ route('admin.pesan.index') }}">
        ...
        <div class="table-responsive text-center">
            ...
            @foreach($messages as $message)
                <tr>
                    ...
                    <td>{{ $date }}</td>
                    <td>
                        <a href="{{ route('admin.pesan.show', ['id' => $message->id]) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Detail"><i class="fas fa-info"></i></i></a>

                        <form onsubmit="return confirm('Hapus Pesan?')" class="d-inline" action="{{route('admin.pesan.destroy', ['id' => $message->id ])}}" method="POST">
                            @method('delete')
                            @csrf
