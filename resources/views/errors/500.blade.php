...
<head>
    ...
    <!-- Title -->
    <title>Halaman yang kamu cari tidak ditemukan</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="wrapper col-8 mx-auto"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
        <title>404</title>
        ...
        <div class="container text-center">
            <div class="mb-2 lead"><strong>Halaman Tidak Ditemukan</strong></div>
            <p><span class="small">Alamat yang anda masukkan salah, tidak tersedia, atau sudah dihapus</span></p>
